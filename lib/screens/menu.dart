import 'package:ec_mobile/screens/list_item.dart';
import 'package:ec_mobile/screens/login.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              const Padding(
                ...
                child: Text(
                  "Eurora's Closet", // Text yang menandakan toko
          ...
          if (item.name == "Tambah Item") {
            ...
            final response = await request.logout(
              // TODO: Ganti URL dan jangan lupa tambahkan trailing slash (/) di akhir URL!
                "https://lidwina-eurora-tugas.pbp.cs.ui.ac.id/auth/logout/");
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  item.name,
                  textAlign: TextAlign.center,
                  style: const TextStyle(color: Color.fromRGBO(248, 237, 227, 1.0), fontSize: 20, fontWeight: FontWeight.bold),
